...
BEGIN
    -- 1. تعريف جميع المتغيرات في البداية لتكون متاحة لكل البلوك
    ...
    BEGIN TRY
        ...
        SELECT 
            ...
            CASE WHEN sls_price IS NULL OR sls_price <= 0 
                 THEN CAST(sls_sales AS FLOAT) / NULLIF(sls_quantity, 0) 
                 ELSE sls_price END
        ...
        SELECT 
            TRIM(id),
            CASE WHEN TRIM(REPLACE(REPLACE(ISNULL(cat, ''), CHAR(13), ''), CHAR(10), '')) = '' THEN 'N/A'
                 ELSE TRIM(REPLACE(REPLACE(cat, CHAR(13), ''), CHAR(10), '')) END,
            CASE WHEN TRIM(REPLACE(REPLACE(ISNULL(subcat, ''), CHAR(13), ''), CHAR(10), '')) = '' THEN 'N/A'
                 ELSE TRIM(REPLACE(REPLACE(subcat, CHAR(13), ''), CHAR(10), '')) END,
            CASE WHEN TRIM(REPLACE(REPLACE(ISNULL(maintenance, ''), CHAR(13), ''), CHAR(10), '')) = '' THEN 'N/A'
                 ELSE TRIM(REPLACE(REPLACE(maintenance, CHAR(13), ''), CHAR(10), '')) END
